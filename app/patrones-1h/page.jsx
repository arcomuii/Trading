...
export const BITUNIX_TICKERS = [
    ...
    'HAEDAL', 'MANTRA', 'WCT', 'OPN', 'F', 'CFG', 'MORPHO', 'TURBO', 'WLFI', 'DOGS', 'JOE', 'WIF', 'CGPT', 'ESP', 'KAT', 'TURTLE', 'SOL', 'SEI', 'VIRTUAL', 'SAHARA', 'SIGN', 'LA', 'CETUS', 'SKY', 'KAITO', 'ZBT', 'HEI', 'NEWT', 'NIGHT', 'BANK', 'CHIP', 'STEEM', 'JUP', 'ZRX', 'BLZ', 'SYRUP', 'CATI', 'AEVO', 'POWR', 'QTUM', 'RARE', 'TNSR', 'ZRO', 'BIO', 'KERNEL', 'ENS', 'GUN', 'ACT', 'ANIME', 'DOT', 'YFI', 'ACH', 'BERA', 'RESOLV', 'LPT', 'NEAR', 'PYTH', 'RIF', 'ETH', 'ILV', 'CELR', 'MAV', 'FET', 'SAND', 'INJ', 'NMR', 'ONG', 'RLC', 'AGLD', 'ROSE', 'ZEC', 'BNB', 'FIL', 'SUI', 'AXL', 'MASK', 'MANTA', 'SAGA', 'BTC', 'ETHFI', 'IO', 'BOME', 'PARTI', 'HMSTR', 'PUMP', 'SCR', 'SOMI', 'SOLV', 'BABY', 'BMT', 'ME', 'LINEA', 'HUMA', 'SAPIEN', 'OPEN', 'C', 'MOVE', 'FRAX', 'A',  
];
