...
const DEFAULT_SYMBOLS = [
    // TODOS FULL
        // "0G","1000000MOG","1000BONK","1000CAT","1000CHEEMS","1000FLOKI","1000LUNC","1000PEPE","1000RATS","1000SATS","1000SHIB","1INCH","1MBABYDOGE","2Z","4","4STOCK","A","AAVE","ACE","ACH","ACT","ACU","ADA","AEON","AERO","AEVO","AGIX","AGLD","AIA","AIGENSYN","AIN","AIO","AIOT","AIXBT","AKE","ALCH","ALGO","ALICE","ALLO","ALPINE","ALT","AMB","ANIME","ANKR","APE","APEX","API3","APP","APR","APT","AR","ARB","ARIA","ARK","ARKM","ARPA","ARX","ASR","ASTER","ASTR","AT","ATH","ATOM","AUCTION","AVA","AVAAI","AVAX","AVNT","AWE","AXL","AXS","AZTEC","B","B2","BABY","BAN","BANANA","BANANAS31","BAND","BANK","BARD","BAS","BASED","BAT","BBX","BCH","BE","BEAMX","BEAT","BERA","BICO","BIGTIME","BIO","BIRB","BITO","BLEND","BLESS","BLUAI","BLUR","BLZ","BMT","BNB","BNC","BNLIFE","BNT","BNX","BOME","BOND","BOT","BR","BRETT","BREV","BROCCOLI","BSB","BSP","BSV","BTC","BTR","BTW","BZ","C","C98","CAKE","CAP","CARV","CASHCAT","CATERPILLAR","CATI","CBRS","CC","CELO","CELR","CETUS","CFG","CFX","CGPT","CHILLGUY","CHIP","CHR","CHZ","CKB","CLANKER","CLO","CNPY","COAI","COLLECT","COMBO","COMP","COOKIE","CORE","COTI","COW","CRO","CROSS","CRV","CRWV","CSOPHLS2L","CSOPSX2L","CTK","CTR","CTSI","CVC","CVX","CYBER","CYS","DAR","DASH","DATAIP","DEEP","DEXE","DGAI","DIA","DOGE","DOGS","DOLO","DOOD","DOS","DOT","DRAM","DRIFT","DUSK","DYDX","DYM","EDEN","EDGEX","EDU","EGLD","EIGEN","ELSA","ENA","ENJ","ENS","ENSO","EPIC","ERA","ESP","ESPORTS","ETC","ETH","ETHFI","ETHW","EUL","EVAA","FARTCOIN","FET","FF","FHE","FIDA","FIGHT","FIL","FLEX","FLNC","FLOCK","FLOW","FLUID","FOGO","FOLKS","FORM","FRAX","FRONT","FTM","FWDI","G","GAL","GALA","GAS","GENIUS","GIGADEV","GIGGLE","GLM","GMT","GMX","GOAT","GPS","GRAM","GRASS","GRIFFAIN","GRT","GRVT","GTC","GUA","GUN","GWEI","H","HAEDAL","HAJIMI","HANA","HBAR","HEI","HEMI","HMSTR","HOLO","HOME","HOT","HUMA","HYPE","HYPER","ICNT","ICP","ID","IDOL","ILV","IMX","IN","INIT","INJ","INTW","INX","IO","IOST","IOTA","IOTX","IRYS","JASMY","JCT","JELLYJELLY","JOE","JST","JTO","JUP","KAIA","KAITO","KAS","KAT","KAVA","KERNEL","KEY","KGEN","KITE","KLAY","KMNO","KNC","KOMA","KORU","KSM","KSTR","LA","LAB","LAYER","LDO","LIGHT","LIGHTER","LINA","LINEA","LINK","LISTA","LIT","LITE","LOOM","LPT","LQTY","LSK","LTC","LUMIA","LUNA2","LYN","LYTE","M","MAGIC","MAGMA","MANA","MANTA","MANTRA","MARSCOIN","MASK","MATIC","MAV","MAVIA","ME","MEGA","MELANIA","MEME","MERL","MET","METIS","MEW","MINA","MINIMAX","MIRA","MITO","MMT","MNT","MOCA","MON","MOODENG","MOONSHOT","MORPHO","MOVE","MOVR","MTL","MUBARAK","MUU","MVLL","MYX","NAORIS","NBIS","NEAR","NEO","NEWT","NIGHT","NIL","NIULAI","NMR","NOM","NOT","NXPC","OCEAN","OG","OGN","OKB","ONDO","ONE","ONG","ONT","OP","OPG","OPN","ORBS","ORCA","ORDER","ORDI","PARTI","PAXG","PENDLE","PENGU","PEOPLE","PHAROS","PI","PIEVERSE","PIPPIN","PIXEL","PLUME","PNUT","POL","POLYX","PONS","POPCAT","PORTAL","POWER","POWR","PRL","PROM","PROMPT","PROVE","PTB","PUMP","PUMPFUN","PUNDIX","PYTH","Q","QNT","QNTX","QTUM","RAD","RAM","RARE","RAVE","RAY","RE","RECALL","RED","REN","RENDER","RESOLV","REZ","RIF","RIVER","RLC","RNDR","ROBO","ROSE","RPL","RSR","RUNE","RVN","SAFE","SAGA","SAHARA","SAND","SAPIEN","SCR","SEI","SENT","SFP","SHAZ","SHELL","SHLD","SIGN","SIREN","SKDD","SKL","SKR","SKUU","SKY","SKYAI","SLP","SLX","SNX","SNXX","SOL","SOLV","SOMI","SONIC","SOON","SOPH","SPACE","SPCX","SPELL","SPK","SPORTFUN","SPX","SQD","SSV","STABLE","STBL","STEEM","STG","STMX","STO","STRK","STX","STXX","SUI","SUN","SUPER","SUSHI","SWARMS","SXT","SYN","SYRUP","TA","TAC","TAG","TAIKO","TAKE","TAO","TEST","TEST1","THE","THETA","TIA","TLM","TMF","TNSR","TOSHI","TOWNS","TRADOOR","TRB","TREE","TRIA","TRUMP","TRUST","TRUTH","TRX","TST","TURBO","TURTLE","TUT","TWT","UAI","UB","UMA","UNFI","UNI","UP","US","USAR","USELESS","USTC","USUAL","VANA","VELODROME","VELVET","VET","VIRTUAL","VTHO","VVV","W","WAL","WAVES","WAXP","WCT","WEN","WET","WIF","WLD","WLFI","WOO","XAI","XAN","XAUT","XEM","XLM","XMR","XNY","XPIN","XPL","XRP","XTZ","XVG","XVS","YB","YFI","YGG","ZAMA","ZBCN","ZBT","ZEC","ZEN","ZEREBRO","ZEST","ZETA","ZHIPU","ZHONGJI","ZIL","ZK","ZKC","ZKP","ZORA","ZRO","ZRX"
    // FILTRADOS
...
export default function BacktestHistoricoPage() {
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            {/* ── Top 200 símbolos con más operativas perdedoras ── */}
            {lossRanking.length > 0 && (
                <details className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-4">
                    <summary className="text-sm font-semibold text-gray-700 dark:text-slate-200 cursor-pointer">
                        Top {Math.min(200, lossRanking.length)} símbolos con más operativas perdedoras
                    </summary>
                    <div className="max-h-96 overflow-y-auto mt-3">
                        <table className="w-full text-xs">
                            <thead className="sticky top-0 bg-white dark:bg-slate-800">
                            ...
                            <tbody>
                                {lossRanking.slice(0, 200).map(([symbol, stats], i) => (
                                    <tr key={symbol} className="border-b border-gray-50 dark:border-slate-800/60">
                                        <td className="py-1 pr-3 text-gray-400 dark:text-slate-500">{i + 1}</td>
                                        <td className="py-1 pr-3 font-semibold text-gray-700 dark:text-slate-200">{symbol}</td>
