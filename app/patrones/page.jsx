                    ...
                    if (data) {
                        ...
                        if (condsMet === conds.length && !levels?.extended) {
                            ...
                            if (isBacktestApexTarget(data) && levels && isFavorableTp2(levels)) {
                                logBacktestEntry({ coin, levels, isBull: bias === 'bullish', patternLabel: meta.label, origen: 'patrones', capital: getTradeAmount(SETTINGS_SCOPE), leverage: getAutoTradeLeverage(SETTINGS_SCOPE) });
                            }
                        }
                    }
                }
